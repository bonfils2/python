...
for m in models:
    if m=='MPI-ESM-P': varss=[var3]; oexpt='past1000'; mm='mpi-esm-p'; mmm='mpi_esm_p'; pp='1'
    if m=='CCSM4':     varss=[var3]; oexpt='past1000'; mm='ccsm4'; mmm='ccsm4'; pp='1'
    if m=='CNRM-CM5':  varss=[var3]; oexpt='past1000'; mm='cnrm'; mmm='cnrm';pp='1'
    if m=='bcc-csm1-1':varss=[var3]; oexpt='past1000'; mm='bcc'; mmm='bcc_csm1_1'; pp='1'
    if m=='MIROC-ESM': varss=[var3]; oexpt='past1000'; mm='miroc-esm'; mmm='miroc_esm'; pp='1'
    if m=='GISS-E2-R':    varss=[var3]; oexpt='past1000'; mm='giss-e2-r'; mmm='giss_e2_r'; pp='121'
    if m=='FGOALS-gl':    varss=[var3]; oexpt='past1000'; mm='fgoals-gl'; mmm='fgoals_gl'; pp='1'
    if m=='IPSL-CM5A-LR': varss=[var3]; oexpt='past1000'; mm='ipsl'; mmm='ipsl_cm5a_lr'; pp='1'
    ...
    for var in varss:
        ...
        f5 = cdms.open('/bonfils2_storage_tmp/MSU/'+var+'/'+mmm+'/r1i1p'+pp+'/'+var+'_'+oexpt+'_'+mmm+'_rmclimo10yr_removed_lrmIce2.nc' )
        #t11=f5(var3)
        t11=f5(var3,regionBEN,time=(yr1,yr2))
        #t11=f5(var3,time=(yr1,yr2))
        ...
        fout=cdms.open('/bonfils2_storage_tmp/MSU/'+var3+'/'+mmm+'/r1i1p'+pp+'/'+var+'_'+oexpt+'_'+mmm+'_rmclimo10yr_removed_lrmIce2'+'.mon.rmSC_8501700.nc','w')
